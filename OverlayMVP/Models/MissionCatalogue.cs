            ...
            new FactionCatalogue
            {
                ...
                Steps = new()
                {
                    ...
                    new TutorialStep
                    {
                        ...
                        StandingGoal     = 3.0f,
                        WhyText          = "At 1.0 standing L2 agents open up. L2 missions clear faster, so you reach storyline triggers (every 16 missions) quicker. Distribution stays the safe choice — no kills, no enemy loss. If you switch to L2 Security for speed, accept that each run kills Guristas and chips their standing. Either way it's the storyline chunks that move Caldari State faction.",
                    ...
                    new TutorialStep
                    {
                        ...
                        StandingGoal     = 5.0f,
                        WhyText          = "L3 agents are the sweet spot for mid-tier pilots — decent ISK and battlecruiser-level content that clears L3 storylines fast. Distribution L3 keeps you clean; security L3 is faster but continues to cost Guristas standing. Reaching 5.0 here unlocks the Penumbra epic arc, which is the big faction payoff.",
            ...
            new FactionCatalogue
            {
                ...
                Steps = new()
                {
                    ...
                    new TutorialStep
                    {
                        ...
                        StandingRequired = 1.0f,
                        StandingGoal     = 3.0f,
                        WhyText          = "At 1.0 standing, L2 agents open. L2 clears faster so you hit storyline triggers sooner. Distribution stays clean (no Serpentis loss); L2 Security is faster but costs Serpentis standing each run. Aim for 3.0 to unlock L3, on the way to the 5.0 that opens the Syndication epic arc.",
            ...
            new FactionCatalogue
            {
                ...
                Steps = new()
                {
                    ...
                    new TutorialStep
                    {
                        ...
                        StandingRequired = 1.0f,
                        StandingGoal     = 3.0f,
                        WhyText          = "L2 MIO clears faster, reaching storyline triggers sooner. Note the tradeoff: L2 SECURITY kills Minmatar/Sansha NPCs (Minmatar standing loss), while L2 DISTRIBUTION stays clean. Sansha are the main combat enemy in Amarr space — full EM resist tank if you do go combat. Keep building toward 5.0 for the Right to Rule epic arc.",
            ...
            new FactionCatalogue
            {
                ...
                Steps = new()
                {
                    ...
                    new TutorialStep
                    {
                        ...
                        StandingRequired = 3.0f,
                        StandingGoal     = 5.0f,
                        WhyText          = "L3 Republic Fleet around Rens/Heimatar is a fast 3.0→5.0 corp-standing path, and frequent L3 storylines feed Minmatar faction standing along the way. A well-fitted battlecruiser handles Angel content cleanly — but remember each combat run still costs Angel standing. The goal is 5.0 to open the repeatable Wildfire epic arc.",
            ...
            new FactionCatalogue
            {
                ...
                Steps = new()
                {
                    ...
                    new TutorialStep
                    {
                        ...
                        StandingRequired = 3.0f,
                        StandingGoal     = 5.0f,
                        WhyText          = "Post-COSMOS, continue with L3 SoE Security near Arnon. A drone-focused ship (Ishtar, Vexor) excels here. SoE combat is pirate-only, so it keeps your empire standings clean. As with every faction, it's the L3 storylines (every 16 missions) that raise SoE faction standing, not each run.",
